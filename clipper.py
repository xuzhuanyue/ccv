...
# 边缘检测
def getCanny(image):
    resultpath = r'D:\project\getCanny.jpg'
    # 高斯模糊
    ...
    cv2.imwrite(resultpath,binary)
    return binary


# 求出面积最大的轮廓
def findMaxContour(image):
    resultpath = r'D:\project\findMaxContour.jpg'
    # 寻找边缘
    ...
    path = r'D:\project\picture.jpg'
    images = cv2.imread(path)
    images = resizeImg(images)
    img=cv2.drawContours(images, contours, -1, (0, 0, 255), 3)
    cv2.imwrite(resultpath,img)#保存轮廓
...
if __name__ == '__main__':
    path = r'D:\project\picture.jpg'
    resultpath = r'D:\project\result.jpg'
